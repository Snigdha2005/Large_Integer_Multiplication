...
assign out = outf;
 ...
 module top #(parameter base_mult = 32, interface_bits = 32, bram_depth = 4)(
     ...
     reg [interface_bits-1:0] x;
     reg [interface_bits-1:0] y;
     ...
     always @* begin
         ...
         else if (p == 0 && (size/base_mult < 1))begin
             x = 32'b00000000000000000000000001000001;
             y = 32'b00000000000000000000000001000001;
         end
         else if (p < size/base_mult) begin
             if (p % 4 == 1) begin
                 x = 32'b00000000000000000000000001000001;
                 y = 32'b00000000000000000000000001000001;
             end
             else if (p % 4 == 2) begin
                x = 32'b00000000000000000000000000000010;
                y = 32'b00000000000000000000000000000010;
             end
             else if (p % 4 == 3)begin
                 x = 32'b00000000000000000000000001000010;
                 y = 32'b00000000000000000000000001000010;
             end
             else begin
     ...
     ila_0 ila_analyse(
         ...
         .probe7(multi.reset),
         .probe8(carry),
         .probe9(multi.mult_result),
         .probe10(multi.shift_pipe2),
         .probe11(multi.dina0),
         .probe12(multi.dina1),
         .probe13(multi.doutb0),
         .probe14(multi.doutb1),
         .probe15(multi.addra0),
         .probe16(multi.addra00),
         .probe17(multi.addrb0),
         .probe18(multi.addrb00),
         .probe19(multi.a_idx),
         .probe20(multi.b_idx),
         ...
         .probe38(multi.c),
         .probe39(multi.mult_pipe),
         .probe40(multi.a_in),
         .probe41(multi.b_in),
         .probe42(multi.dut.x_1),
         .probe43(multi.dut.y_1),
         .probe44(multi.addra01),
         .probe45(multi.addrb01),
         .probe46(multi.douta0),
         .probe47(multi.web),
         .probe48(multi.dut.out),
         .probe49(multi.in1),
         .probe50(multi.in2),
         .probe51(multi.dut.x11),
         .probe52(multi.dut.x21),
         .probe53(multi.dut.y11),
         .probe54(multi.dut.y21),
         .probe55(multi.douta1)
     );
